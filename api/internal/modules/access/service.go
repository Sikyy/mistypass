...
func NewService() *Service {
	...
	return &Service{
		...
		schedules: []Schedule{
			{
				ID:          "sched_office_hours_jkt",
				TenantID:    "tenant_demo_jakarta",
				Name:        "Office Hours",
				Description: "Standard weekday office access",
				ValidFrom:   "2026-01-01",
				ValidUntil:  "2026-12-31",
				TimeWindows: []TimeWindow{
					{StartTime: "07:00", EndTime: "19:00", DayOfWeekSet: "Mon,Tue,Wed,Thu,Fri", Timezone: "Asia/Jakarta"},
				},
				CreatedAt: now,
				UpdatedAt: now,
			},
			{
				ID:          "sched_24_7_security",
				TenantID:    "tenant_demo_jakarta",
				Name:        "24/7 Security Access",
				Description: "Round-the-clock access for security personnel",
				ValidFrom:   "2026-01-01",
				ValidUntil:  "2026-12-31",
				TimeWindows: []TimeWindow{
					{StartTime: "00:00", EndTime: "23:59", DayOfWeekSet: "Mon,Tue,Wed,Thu,Fri,Sat,Sun", Timezone: "Asia/Jakarta"},
				},
				CreatedAt: now,
				UpdatedAt: now,
			},
			{
				ID:          "sched_weekend_maintenance",
				TenantID:    "tenant_demo_jakarta",
				Name:        "Weekend Maintenance",
				Description: "Weekend maintenance window for facility team",
				ValidFrom:   "2026-01-01",
				ValidUntil:  "2026-12-31",
				TimeWindows: []TimeWindow{
					{StartTime: "08:00", EndTime: "17:00", DayOfWeekSet: "Sat,Sun", Timezone: "Asia/Jakarta"},
				},
				CreatedAt: now,
				UpdatedAt: now,
			},
