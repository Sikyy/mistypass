	...
	return &Service{
		...
		doors: []Door{
			...
			},
			{
				...
				FloorID:    "floor_demo_001",
				AreaID:     "area_demo_001",
				Name:       "B-12 West Lobby",
				GatewayID:  "MP-GW-JKT-0002",
				Kind:       "lobby",
				Status:     "online",
				CreatedAt:  now,
			},
			{
				...
				FloorID:    "floor_demo_001",
				AreaID:     "area_demo_001",
				Name:       "C-5 Server Room",
				GatewayID:  "MP-GW-JKT-0003",
				Kind:       "secure",
				Status:     "online",
				CreatedAt:  now,
			},
			{
				...
				FloorID:    "floor_demo_001",
				AreaID:     "area_demo_001",
				Name:       "Parking Gate P1",
				GatewayID:  "MP-GW-JKT-0004",
				Kind:       "gate",
				Status:     "online",
				CreatedAt:  now,
			},
		...
		doorGroups: []DoorGroup{
			{
				...
				DoorIDs:   []string{"door_jkt_001", "door_jkt_002", "door_jkt_003", "door_jkt_004", "door_jkt_005", "door_jkt_006", "door_jkt_014"},
				CreatedAt: now,
			},
			{
				ID:        "dg_1001",
