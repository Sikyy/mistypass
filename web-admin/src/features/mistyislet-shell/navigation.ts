  ...
  return [
    ...
    },
    {
      ...
      entries: [
        ...
        { label: t("nav.alarms"), icon: BellIcon, to: "/alarms" },
    ...
    },
    {
      ...
      entries: [
        ...
        { label: t("nav.apiClients"), icon: KeyRoundIcon, to: "/developer/api-clients" },
        ...
        { label: t("kisi.shell.navSsoScim"), icon: KeyRoundIcon, to: "/enterprise" },
