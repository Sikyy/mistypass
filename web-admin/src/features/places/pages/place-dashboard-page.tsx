...
export function PlaceDashboardAdaptedPage({
  ...
  const cards = [
    [
      ...
      place?.offlineCount ? `${place.offlineCount} resource needs review` : t("kisi.home.noAlertQueue"),
      DoorOpenIcon,
      place?.offlineCount ? "warning" : "success",
    ],
    [t("kisi.placeDashboard.todayUnlocks"), todayEvents.length.toLocaleString(), t("kisi.home.gatewayPoints"), HistoryIcon, "info"],
    [t("kisi.placeDashboard.activeUsers"), activeUsers.toString(), t("kisi.home.gatewayPoints"), UsersIcon, "success"],
    [
      t("kisi.placeDashboard.openAlerts"),
      reviewCount.toString(),
      reviewCount > 0 ? t("kisi.home.followUp") : t("kisi.home.noReviewBacklog"),
      AlertCircleIcon,
