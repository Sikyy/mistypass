...
function TableCellText({ className, title, children, ...props }: React.ComponentProps<"span">) {
  const fallbackTitle = typeof children === "string" ? children : undefined
  return (
    <span
      data-slot="table-cell-text"
      className={cn("block max-w-full truncate whitespace-nowrap align-bottom", className)}
